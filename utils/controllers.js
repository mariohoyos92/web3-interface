...
const { getTransaction, getCodeHistory, getAuthCodes } = require('../kyc-service');
const { getUserByEmail, updateNetkiApprovedStatus, checkIfCodeInUse, addUsertoDB, addAddressToUser } = require("./dbAcessors");
...
module.exports = { netkiStatusFetcher, getCrowdSaleStats, getRemainingTokensInRound, registerUser, getUserProfile, addAddressToProfile, checkIfWhitelisted, getTransactionHistory, getMDXBalance, getTotalRemainingTokens }